...
module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c26 = function(f, l) { return ast.Tex.PAREN(f, l); },
        peg$c27 = function(r) { return ast.Tex.LITERAL(r); },
        peg$c28 = function(b, r) { return ast.Tex.BIG(b, r); },
        peg$c29 = function(b) { return ast.Tex.BIG(b, sq_close_ri); },
        peg$c30 = function(l, e, r) { return ast.Tex.LR(l, r, e.toArray()); },
        peg$c31 = function(name, e, l) { return ast.Tex.FUN2sq(name, ast.Tex.CURLY(e.toArray()), l); },
        peg$c32 = function(name, l) { return ast.Tex.FUN1(name, l); },
        peg$c33 = function(name, l) { return ast.Tex.FUN1nb(name, l); },
        peg$c34 = function(f, l) { return ast.Tex.FUN1hl(f[0], f[1], l); },
        peg$c35 = function(f, l) { return ast.Tex.FUN1hf(f[0], f[1], l); },
        peg$c36 = function(name, l1, l2) { return ast.Tex.FUN2(name, l1, l2); },
        peg$c37 = function(name, l1, l2) { return ast.Tex.FUN2nb(name, l1, l2); },
        peg$c38 = function(f, l1, l2) { return ast.Tex.FUN2h(f[0], f[1], l1, l2); },
        peg$c39 = function(name, l1, l2, l3) { return ast.Tex.FUN3(name, l1, l2, l3); },
        peg$c40 = function(e) { return ast.Tex.CURLY(e.toArray()); },
        peg$c41 = function(e1, name, e2) { return ast.Tex.INFIX(name, e1.toArray(), e2.toArray()); },
        peg$c42 = function(e1, f, e2) { return ast.Tex.INFIXh(f[0], f[1], e1.toArray(), e2.toArray()); },
        peg$c43 = function(m) { return ast.Tex.MATRIX("matrix", lst2arr(m)); },
        peg$c44 = function(m) { return ast.Tex.MATRIX("pmatrix", lst2arr(m)); },
        peg$c45 = function(m) { return ast.Tex.MATRIX("bmatrix", lst2arr(m)); },
        peg$c46 = function(m) { return ast.Tex.MATRIX("Bmatrix", lst2arr(m)); },
        peg$c47 = function(m) { return ast.Tex.MATRIX("vmatrix", lst2arr(m)); },
        peg$c48 = function(m) { return ast.Tex.MATRIX("Vmatrix", lst2arr(m)); },
        peg$c49 = function(m) { return ast.Tex.MATRIX("array", lst2arr(m)); },
        peg$c50 = function(m) { return ast.Tex.MATRIX("aligned", lst2arr(m)); },
        peg$c51 = function(m) { return ast.Tex.MATRIX("alignedat", lst2arr(m)); },
        peg$c52 = function(m) { return ast.Tex.MATRIX("smallmatrix", lst2arr(m)); },
        peg$c53 = function(m) { return ast.Tex.MATRIX("cases", lst2arr(m)); },
        peg$c54 = "\\begin{",
        peg$c55 = { type: "literal", value: "\\begin{", description: "\"\\\\begin{\"" },
        peg$c56 = "}",
        peg$c57 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c58 = function() { throw new SyntaxError("Illegal TeX function", [], text(), offset(), line(), column()); },
        peg$c59 = function(f) { return !tu.all_functions[f]; },
        peg$c60 = void 0,
        peg$c61 = function(f) { throw new SyntaxError("Illegal TeX function", [], f, offset(), line(), column()); },
        peg$c62 = function(cs, m) { m.head[0].unshift(cs); return m; },
        peg$c63 = function(as, m) { m.head[0].unshift(as); return m; },
        peg$c64 = null,
        peg$c65 = function(m) { return m; },
        peg$c66 = function(l, tail) { return { head: lst2arr(l), tail: tail }; },
        peg$c67 = function(f, l) { l.head.unshift(ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(f + " "))); return l;},
        peg$c68 = function(l) { return l; },
        peg$c69 = function(e, tail) { return { head: e.toArray(), tail: tail }; },
        peg$c70 = function() { return text(); },
        peg$c71 = function(cs) { return ast.Tex.CURLY([ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(cs))]); },
        peg$c72 = /^[lrc]/,
        peg$c73 = { type: "class", value: "[lrc]", description: "[lrc]" },
        peg$c74 = "p",
        ...
        peg$c86 = function(num) { return ast.Tex.CURLY([ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(num))]); },
        peg$c87 = "[",
        peg$c88 = { type: "literal", value: "[", description: "\"[\"" },
        peg$c89 = /^[tcb]/,
        peg$c90 = { type: "class", value: "[tcb]", description: "[tcb]" },
        peg$c91 = "]",
        ...
        peg$c105 = /^[\-0-9a-zA-Z+*,=():\/;?.!'` \x80-\uD7FF\uE000-\uFFFF]/,
        peg$c106 = { type: "class", value: "[\\-0-9a-zA-Z+*,=():\\/;?.!'` \\x80-\\uD7FF\\uE000-\\uFFFF]", description: "[\\-0-9a-zA-Z+*,=():\\/;?.!'` \\x80-\\uD7FF\\uE000-\\uFFFF]" },
        peg$c107 = /^[\uD800-\uDBFF]/,
        peg$c108 = { type: "class", value: "[\\uD800-\\uDBFF]", description: "[\\uD800-\\uDBFF]" },
        peg$c109 = /^[\uDC00-\uDFFF]/,
        peg$c110 = { type: "class", value: "[\\uDC00-\\uDFFF]", description: "[\\uDC00-\\uDFFF]" },
        peg$c111 = function(l, h) { return text(); },
        peg$c112 = function(b) { return tu.box_functions[b]; },
        peg$c113 = "{",
        peg$c114 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c115 = function(b, cs) { return ast.Tex.BOX(b, cs.join('')); },
        peg$c116 = "-",
        peg$c117 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c118 = function(c) { return ast.RenderT.TEX_ONLY(c); },
        peg$c119 = function(f) { return tu.latex_function_names[f]; },
        peg$c120 = "\\{",
        peg$c121 = { type: "literal", value: "\\{", description: "\"\\\\{\"" },
        peg$c122 = function() { return " ";},
        peg$c123 = function(f, c) { return ast.RenderT.TEX_ONLY(f + c); },
        peg$c124 = function(f) { return tu.mediawiki_function_names[f]; },
        peg$c125 = function(f, c) { return ast.RenderT.TEX_ONLY("\\operatorname {" + f.slice(1) + "}" + c); },
        peg$c126 = function(f) { return tu.other_literals1[f]; },
        peg$c127 = function(f) { return ast.RenderT.TEX_ONLY(f + " "); },
        peg$c128 = function(f) { return tu.other_literals2[f]; },
        peg$c129 = function(f) { return ast.RenderT.TEX_ONLY("\\mbox{" + f + "} "); },
        peg$c130 = function(mbox) { return mbox === "\\mbox"; },
        peg$c131 = function(mbox, f) { return tu.other_literals2[f]; },
        peg$c132 = function(mbox, f) { return ast.RenderT.TEX_ONLY("\\mbox{" + f + "} "); },
        peg$c133 = function(f) { return tu.other_literals3[f]; },
        peg$c134 = function(f) { return ast.RenderT.TEX_ONLY(tu.other_literals3[f] + " "); },
        peg$c135 = function(f) { return ast.RenderT.TEX_ONLY(f); },
        peg$c136 = "\\",
        peg$c137 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c138 = /^[, ;!_#%$&]/,
        peg$c139 = { type: "class", value: "[, ;!_#%$&]", description: "[, ;!_#%$&]" },
        peg$c140 = function(c) { return ast.RenderT.TEX_ONLY("\\" + c); },
        peg$c141 = /^[><~]/,
        peg$c142 = { type: "class", value: "[><~]", description: "[><~]" },
        peg$c143 = /^[%$]/,
        peg$c144 = { type: "class", value: "[%$]", description: "[%$]" },
        peg$c145 = function(c) { return ast.RenderT.TEX_ONLY("\\" + c); /* escape dangerous chars */},
        peg$c146 = /^[{}|]/,
        peg$c147 = { type: "class", value: "[{}|]", description: "[{}|]" },
        peg$c148 = function(f) { return tu.other_delimiters1[f]; },
        peg$c149 = function(f) { return tu.other_delimiters2[f]; },
        peg$c150 = function(f) { return ast.RenderT.TEX_ONLY(tu.other_delimiters2[f] + " "); },
        peg$c151 = function(f) { return tu.fun_ar1nb[f]; },
        peg$c152 = function(f) { return f; },
        peg$c153 = function(f) { return tu.fun_ar1opt[f]; },
        peg$c154 = "&",
        peg$c155 = { type: "literal", value: "&", description: "\"&\"" },
        peg$c156 = "\\\\",
        peg$c157 = { type: "literal", value: "\\\\", description: "\"\\\\\\\\\"" },
        peg$c158 = "\\begin",
        peg$c159 = { type: "literal", value: "\\begin", description: "\"\\\\begin\"" },
        peg$c160 = "\\end",
        peg$c161 = { type: "literal", value: "\\end", description: "\"\\\\end\"" },
        peg$c162 = "{matrix}",
        peg$c163 = { type: "literal", value: "{matrix}", description: "\"{matrix}\"" },
        peg$c164 = "{pmatrix}",
        peg$c165 = { type: "literal", value: "{pmatrix}", description: "\"{pmatrix}\"" },
        peg$c166 = "{bmatrix}",
        peg$c167 = { type: "literal", value: "{bmatrix}", description: "\"{bmatrix}\"" },
        peg$c168 = "{Bmatrix}",
        peg$c169 = { type: "literal", value: "{Bmatrix}", description: "\"{Bmatrix}\"" },
        peg$c170 = "{vmatrix}",
        peg$c171 = { type: "literal", value: "{vmatrix}", description: "\"{vmatrix}\"" },
        peg$c172 = "{Vmatrix}",
        peg$c173 = { type: "literal", value: "{Vmatrix}", description: "\"{Vmatrix}\"" },
        peg$c174 = "{array}",
        peg$c175 = { type: "literal", value: "{array}", description: "\"{array}\"" },
        peg$c176 = "{align}",
        peg$c177 = { type: "literal", value: "{align}", description: "\"{align}\"" },
        peg$c178 = "{aligned}",
        peg$c179 = { type: "literal", value: "{aligned}", description: "\"{aligned}\"" },
        peg$c180 = "{alignat}",
        peg$c181 = { type: "literal", value: "{alignat}", description: "\"{alignat}\"" },
        peg$c182 = "{alignedat}",
        peg$c183 = { type: "literal", value: "{alignedat}", description: "\"{alignedat}\"" },
        peg$c184 = "{smallmatrix}",
        peg$c185 = { type: "literal", value: "{smallmatrix}", description: "\"{smallmatrix}\"" },
        peg$c186 = "{cases}",
        peg$c187 = { type: "literal", value: "{cases}", description: "\"{cases}\"" },
        peg$c188 = "^",
        peg$c189 = { type: "literal", value: "^", description: "\"^\"" },
        peg$c190 = "_",
        peg$c191 = { type: "literal", value: "_", description: "\"_\"" },
        peg$c192 = function(f) { return tu.big_literals[f]; },
        peg$c193 = function(f) { return tu.paren[f]; },
        peg$c194 = function(f) { return tu.fun_ar1[f]; },
        peg$c195 = function(f) { return tu.other_fun_ar1[f]; },
        peg$c196 = function(f) { return tu.fun_ar2[f]; },
        peg$c197 = function(f) { return tu.fun_ar3[f]; },
        peg$c198 = function(f) { return tu.fun_infix[f]; },
        peg$c199 = function(f) { return tu.declh_function[f]; },
        peg$c200 = function(f) { return ast.Tex.DECLh(f, ast.FontForce.RM(), []); /*see bug 54818*/ },
        peg$c201 = function(f) { return tu.fun_ar2nb[f]; },
        peg$c202 = function(f) { return tu.left_function[f]; },
        peg$c203 = function(f) { return tu.right_function[f]; },
        peg$c204 = function(f) { return tu.hline_function[f]; },
        peg$c205 = function(f) { return tu.color_function[f]; },
        peg$c206 = function(f, cs) { return f + " " + cs; },
        peg$c207 = function(f) { return tu.definecolor_function[f]; },
        peg$c208 = "named",
        peg$c209 = { type: "literal", value: "named", description: "\"named\"" },
        peg$c210 = function(cs) { return "{named}" + cs; },
        peg$c211 = "gray",
        peg$c212 = { type: "literal", value: "gray", description: "\"gray\"" },
        peg$c213 = function(cs) { return "{gray}" + cs; },
        peg$c214 = "rgb",
        peg$c215 = { type: "literal", value: "rgb", description: "\"rgb\"" },
        peg$c216 = function(cs) { return "{rgb}" + cs; },
        peg$c217 = "cmyk",
        peg$c218 = { type: "literal", value: "cmyk", description: "\"cmyk\"" },
        peg$c219 = function(cs) { return "{cmyk}" + cs; },
        peg$c220 = function(f, name, a) { return f + " {" + name.join('') + "}" + a; },
        peg$c221 = function(cs) { return "[named]" + cs; },
        peg$c222 = function(cs) { return "[gray]" + cs; },
        peg$c223 = function(cs) { return "[rgb]" + cs; },
        peg$c224 = function(cs) { return "[cmyk]" + cs; },
        peg$c225 = function(name) { return "{" + name.join('') + "}"; },
        peg$c226 = function(k) { return "{"+k+"}"; },
        peg$c227 = ",",
        peg$c228 = { type: "literal", value: ",", description: "\",\"" },
        peg$c229 = function(r, g, b) { return "{"+r+","+g+","+b+"}"; },
        peg$c230 = function(c, m, y, k) { return "{"+c+","+m+","+y+","+k+"}"; },
        peg$c231 = /^[01]/,
        peg$c232 = { type: "class", value: "[01]", description: "[01]" },
        peg$c233 = ".",
        peg$c234 = { type: "literal", value: ".", description: "\".\"" },
        peg$c235 = function() { return text().replace(/\s+$/g, ''); },
