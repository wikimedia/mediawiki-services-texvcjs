 ...
 = f:generic_func &{ return tu.definecolor_function[f]; } _
   "{" _ name:alpha+ _ "}" _ "{" _
     a:( "named"i _ "}" _ cs:COLOR_SPEC_NAMED { return "{named}" + cs; }
       ...
       / "rgb"    _ "}" _ cs:COLOR_SPEC_RGB1  { return "{rgb}" + cs; }
       / "RGB"    _ "}" _ cs:COLOR_SPEC_RGB2  { return "{RGB}" + cs; }
...
COLOR_SPEC
 ...
 / "[" _ "gray"i _ "]" _ cs:COLOR_SPEC_GRAY
   { return "[gray]" + cs; }
 / "[" _ "rgb"  _ "]" _ cs:COLOR_SPEC_RGB1
   { return "[rgb]" + cs; }
 / "[" _ "RGB"  _ "]" _ cs:COLOR_SPEC_RGB2
   { return "[rgb]" + cs; }
...
COLOR_SPEC_RGB1
 = "{" _ r:CNUM "," _ g:CNUM "," _ b:CNUM "}" _
   { return "{"+r+","+g+","+b+"}"; }
COLOR_SPEC_RGB2
 = "{" _ r:CNUM2 "," _ g:CNUM2 "," _ b:CNUM2 "}" _
   { return "{"+r+","+g+","+b+"}"; }
COLOR_SPEC_CMYK
