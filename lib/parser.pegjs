...
lit
  =
    f:PAREN atsymbol l:lit      { return ast.Tex.PAREN(f, l); }
  / f:PAREN l:litparen1  { return ast.Tex.PAREN(f, l); } //must be before LITERAL!!
...
litstuff = //basically lit without DELIMITER or LITERAL as the last option, needed because they interrupt the parsing of commands in PAREN.
    f:PAREN atsymbol l:lit      { return ast.Tex.PAREN(f, l); }
  / f:PAREN l:litparen1  { return ast.Tex.PAREN(f, l); } //must be before LITERAL!!
  / b:BIG r:DELIMITER           { return ast.Tex.BIG(b, r); }
  / b:BIG SQ_CLOSE              { return ast.Tex.BIG(b, sq_close_ri); }
...
PAREN
 = f:generic_func &{ return tu.paren[f]; } _ { return f; }
...
FUN_AR3
 = f:generic_func &{ return tu.fun_ar3[f]; } _
   { return f; }
